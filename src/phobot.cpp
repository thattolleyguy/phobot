/*
	JJROBOTS_PHOBOT.cpp -  Library for JJROBOTS PHOBOT board.
...
void PHOBOT_Class::moveServo1(int pwm)
{
...
void PHOBOT_Class::moveServo2(int pwm)
{
  pwm = constrain(pwm,servo_min_pwm,servo_max_pwm)>>3;  // Check max values and Resolution: 8us
  // 11 bits => 3 MSB bits on TC4H, LSB bits on OCR4B
  TC4H = pwm>>8;
